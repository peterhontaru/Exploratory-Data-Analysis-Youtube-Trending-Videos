...
### Correlation plot:
![YouTube Trending Page](_support files\1 - Correlation Plot-1.png)

![YouTube Trending Page](_support files\2 - overall videos by country-1.png)

![YouTube Trending Page](_support files\3 - Trending Days Timespan-1.png)

![YouTube Trending Page](_support files\4- View Spread-1.png)

![YouTube Trending Page](_support files\5 - Views by Category-1.png)
